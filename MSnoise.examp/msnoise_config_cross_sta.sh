...
#sqlite3 msnoise.sqlite "UPDATE config SET value = '2014-09-23' WHERE name = 'ref_end'" # before SSE2
#sqlite3 msnoise.sqlite "UPDATE config SET value = '2014-08-31' WHERE name = 'ref_end'" # before SSE1
#-------------------------
